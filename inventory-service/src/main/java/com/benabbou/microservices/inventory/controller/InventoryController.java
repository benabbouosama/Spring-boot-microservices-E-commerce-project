...
public class InventoryController {
    ...
    public StockCheckResponse isInStock(@RequestParam String skuCode, @RequestParam Integer quantity) {
        return inventoryService.checkStockAvailability(skuCode, quantity);
    }
}
